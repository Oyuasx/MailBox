...
CONSTRAINT fk_yollayan_kisi_no FOREIGN KEY (yollayan_kisi_no) REFERENCES login_user(id),
...
CONSTRAINT fk_alan_kisi_no FOREIGN KEY (alan_kisi_no) REFERENCES login_user(id),
...
alýnan_mail_icerik varchar(8000) NOT NULL,
...
INSERT INTO mail_get_user(alan_kisi_no,yollayan_kisi,mail_alma_tarhi,alýnan_mail_konu,alýnan_mail_icerik) VALUES ('1', 'ulaa mehmet', '12.12.2000', 'ulululuaa', 'bu nasýl içeriktir looo')
